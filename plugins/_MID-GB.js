...
this.sendMessage(m.chat, {text: `🐈 𝙉𝙊 𝙏𝙄𝙀𝙉𝙀 𝙂𝘼𝙏𝘼𝘾𝙊𝙄𝙉𝙎`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: '『𝑹𝑰𝑻𝑨 𝑩𝑶𝑻 ﹝🍉﹞ 𝑴𝑹_𝑨𝑶𝑲𝑰𝑱𝑰 』', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
continue     
}
			
m.exp += xp
if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
this.sendMessage(m.chat, {text: `${lenguajeGB['smsCont7']()} *${usedPrefix}buy*`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: '『𝑹𝑰𝑻𝑨 𝑩𝑶𝑻 ﹝🍉﹞ 𝑴𝑹_𝑨𝑶𝑲𝑰𝑱𝑰 』', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
//this.reply(m.chat, `${lenguajeGB['smsCont7']()} *${usedPrefix}buy*`, m)
continue //Sin límite
}
if (plugin.level > _user.level) {
this.sendMessage(m.chat, {text: `${lenguajeGB['smsCont9']()} *${plugin.level}* ${lenguajeGB['smsCont10']()} *${_user.level}* ${lenguajeGB['smsCont11']()} *${usedPrefix}nivel*`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: '『𝑹𝑰𝑻𝑨 𝑩𝑶𝑻 ﹝🍉﹞ 𝑴𝑹_𝑨𝑶𝑲𝑰𝑱𝑰 』', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
...
if (db.data.chats[m.chat].reaction && m.text.match(/(هلا|اك|اوكيجي|تم|خخ|اوك|السلام|سلام|اوبس|ما|غو|بلا|سو|نا)/)) {
...
text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || 'Welcome, @user!').replace('@subject', await this.getName(id)).replace('@desc', groupMetadata.desc?.toString() || '『𝑹𝑰𝑻𝑨 𝑩𝑶𝑻 ﹝🍉﹞ 𝑴𝑹_𝑨𝑶𝑲𝑰𝑱𝑰 』') :
...
let prefijos = (Array.isArray(chat.sCondition) && chat.sCondition.length > 0) || chat.sCondition !== "" ? chat.sCondition : p
